...
//          @"White": [UIColor colorWithRed:255.0f/255.0f green:255.0f/255.0f blue:255.0f/255.0f alpha:1.0f]
          @"blackColor": UIColor.blackColor, @"blueColor": UIColor.blueColor, @"brownColor": UIColor.brownColor,
          @"grayColor": UIColor.grayColor, @"greenColor": UIColor.greenColor, @"magentaColor": UIColor.magentaColor,
          @"orangeColor": UIColor.orangeColor, @"purpleColor": UIColor.purpleColor, @"redColor": UIColor.redColor,
          @"yellowColor": UIColor.yellowColor, @"whiteColor": UIColor.whiteColor
        };
    });
    return realmColors;
}
