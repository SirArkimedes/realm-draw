...
class PermissionsClient extends ServiceClientBase_1.ServiceClientBase {
    constructor() {
        super(...arguments);
        this.serviceName = "permissions";
        this.baseRoute = "permissions";
    }
    onDemand(token) {
        return __awaiter(this, void 0, void 0, function* () {
            const route = yield this.getRoute("ondemand");
            const request = superagent.get(route);
            return yield this.executeRequest(request, token);
        });
    }
    applyPermissions(changeRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            const route = yield this.getRoute("apply");
