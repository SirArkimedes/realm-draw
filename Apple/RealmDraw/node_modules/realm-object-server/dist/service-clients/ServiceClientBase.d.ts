...
export declare abstract class ServiceClientBase {
    ...
    constructor(discovery: Discovery, adminToken: string, authorizationHeaderName: string, tags?: string[]);
    ...
    protected executeRequest(request: superagent.SuperAgentRequest, token?: string): Promise<any>;
}
