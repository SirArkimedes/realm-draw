...
class InvalidRealmType extends RealmProblem {
    constructor(expectedType, actualType) {
        super();
        this.path = "invalid-realm-type";
        this.title = "The type of the Realm file was invalid.";
        this.status = 400;
        this.code = 619;
    ...
    get message() {
        return `${super.message} Expected ${this.expectedType} but got ${this.actualType}.`;
    }
}
exports.InvalidRealmType = InvalidRealmType;
...
class NotSupported extends RealmProblem {
    constructor() {
        super(...arguments);
        this.path = "not-enabled";
        this.title = "The server was not configured to support the requested operation.";
        this.status = 501;
        this.code = 803;
    }
}
