...
let PermissionsService = PermissionsService_1 = class PermissionsService extends events_1.EventEmitter {
    ...
    start(server) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield new Promise((resolve) => Realm.Sync["_waitForUpload"](this.adminRealm, resolve));
            ...
            yield server.discovery.waitForService("realms");
    ...
    grantReadOnlyAccessToWildcardPermissionRealm() {
        return __awaiter(this, void 0, void 0, function* () {
            const exposeAsReadOnly = (realmPath) => __awaiter(this, void 0, void 0, function* () {
                const wildcardRealmFile = yield shared_1.waitAsync(() => this.adminRealm.objectForPrimaryKey("RealmFile", realmPath), undefined, 15000, false);
