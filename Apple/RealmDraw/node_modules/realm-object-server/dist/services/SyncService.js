    ...
    start(server) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const config = {
                ...
                featureToken: this.config.featureToken || process.env.SYNC_WORKER_FEATURE_TOKEN,
                ...
                enableLogCompaction: this.config.enableLogCompaction,
                historyCompactionInterval: this.config.historyCompactionInterval,
                historyTtl: this.config.historyTtl,
                shouldCompactRealmsAtStart: this.config.shouldCompactRealmsAtStart,
                shouldPerformPartialSyncAtStart: this.config.shouldPerformPartialSyncAtStart,
                enableRealmStateSizeReporting: this.config.enableRealmStateSizeReporting,
            };
            if (this.stats) {
                ...
                config.statsEndpoint = `${address}:${port}`;
                statsLogger.debug(`Started listening for stats on ${config.statsEndpoint}`);
            }
