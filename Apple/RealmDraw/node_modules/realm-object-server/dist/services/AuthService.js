...
let AuthService = AuthService_1 = class AuthService {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (token.isAdmin) {
                ...
                if (partialSyncPath) {
                    ...
                    AuthService_1.ensureRealmOfType(realms_1.RealmType.reference, realmResponseReference.realmType);
                ...
                if (partialSyncPath) {
                    ...
                    if (!realmResponseReference.exists) {
                        throw new errors.realm.AccessDenied({
                            detail: `Failed to create a reference realm for '${path};`
                        });
                    }
                    AuthService_1.ensureRealmOfType(realms_1.RealmType.reference, realmResponseReference.realmType);
                    const realmResponsePartial = yield this.server.realmDirectoryClient.findByPath({
                    ...
                    AuthService_1.ensureRealmOfType(realms_1.RealmType.full, realmResponse.realmType);
                    syncLabel = realmResponse.syncLabel;
    ...
    getUserByProviderIdApi(provider, providerId, req) {
        ...
        if (user && (Token_2.isAdminToken(req.authToken) || user.userId === req.authToken.identity)) {
            return user;
        }
        throw new errors.realm.UnknownAccount();
    }
    ...
    updateProviderAccount(providerName, data, req, providerId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const isAuthenticated = !!(req.authToken && (Token_2.isAdminToken(req.authToken) || (user && req.authToken.identity === user.userId)));
    ...
    requireAdminOrUserId(req, userId) {
        if (!Token_2.isAdminToken(req.authToken)) {
            if (!userId) {
                throw new errors.realm.AccessDenied();
            }
    ...
    deleteUserWithUserId(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield Promise.all(filesToDelete.map((file) => __awaiter(this, void 0, void 0, function* () {
                ...
                yield client.deleteRealm(file.path).catch((err) => {
