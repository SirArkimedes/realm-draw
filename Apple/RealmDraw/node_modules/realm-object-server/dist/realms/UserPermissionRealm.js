...
function CreateLegacyUserPermissionRealmDefinition(userId) {
    return {
...
exports.CreateLegacyUserPermissionRealmDefinition = CreateLegacyUserPermissionRealmDefinition;
function CreateUserPermissionRealmDefinition(userId) {
    return {
        remotePath: `/${userId}/__perm`,
        schema: [
