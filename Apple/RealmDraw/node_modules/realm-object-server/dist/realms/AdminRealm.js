...
UserMetadataRow.schema = {
    ...
    properties: {
        users: { type: "linkingObjects", objectType: "User", property: "metadata" },
...
class User {
    ...
    isEmailConfirmed() {
        const metadataEntry = this.metadata.find(m => m.key === "isEmailConfirmed");
        return (metadataEntry && metadataEntry.value === "true") || false;
    }
    toJSON() {
        return {
            user_id: this.userId,
    ...
    static fromJSON(json) {
        ...
        result.isAdmin = json.is_admin;
        result.accounts = json.accounts.map(Account.fromJSON);
...
Account.schema = {
    ...
    properties: {
        ...
        users: { type: "linkingObjects", objectType: "User", property: "accounts" }
    }
};
...
RealmFile.schema = {
    ...
    properties: {
        path: "string",
        realmType: { type: "string", optional: false },
        syncLabel: "string",
